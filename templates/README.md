...
There are templates available for Python, a Unix shell, and R. See the [Bootstrap your Project](../README.md#bootstrap-your-project) section of the [RC-CLI readme](../README.md#bootstrap-your-project) for more information. This is an example file structure for a Python-based solution.
